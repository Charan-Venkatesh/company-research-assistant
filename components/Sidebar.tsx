        ...
        {tab === "discord" && (
          <div className="space-y-5">
            ...
            <div className="space-y-4 pt-2 border-t border-hairline">
              ...
              <div>
                <label htmlFor="name" className="block text-xs text-muted mb-1">Full Name</label>
                <input
                  id="name"
                  type="text"
                  value={name}
              ...
              <div>
                <label htmlFor="email" className="block text-xs text-muted mb-1">Email Address</label>
                <input
                  id="email"
                  type="email"
                  value={email}
